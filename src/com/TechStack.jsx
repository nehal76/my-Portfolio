...
export const TechStack = () => {
  ...
  const filtersearch = Tecknology.filter(
    (tech) =>
    ...
    <>
      <section ref={sectionRef} className="py-24 px-4 sm:px-6 bg-white ">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="font-outfit text-center font-bold text-3xl sm:text-4xl lg:text-5xl text-gray-900 mb-6">
            Tech Stack
          </h2>
            ...
            {filtersearch.map((tech, index) => (
              ...
              >
                <div className="text-center">
                  <div
                    className='className="text-4xl sm:text-5xl mb-3 sm:mb-4 mx-auto p-3 rounded-full transition-transform duration-300 hover:scale-125 "
                  aria-hidden'
                  >
                    {tech.icon}
                  </div>
