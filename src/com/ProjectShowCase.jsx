  ...
  const projects = [
    {
      ...
      github: "https://github.com/nehal76/ca-frontend-vit",
      live: "https://shuaib-ca.netlify.app",
    },
    // {
    //   title: "IntriAI",
    //   description:
    //     "AI-powered SaaS platform that redesigns any room photo based on user-selected room type and design style, with credit-based usage and Stripe payment integration.",
    ...
    //   description:
    //     "A version control system platform inspired by GitHub, supporting repository creation, commits, branches, and collaboration tools using the MERN stack.",
    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="font-inter text-base sm:text-xl text-gray-800 max-w-2xl mx-auto">
                  ...
                  <div className="absolute inset-0 bg-black/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    <div className="flex gap-4">
                      <a
                        ...
                        className="bg-white/90 p-3 rounded-full hover:bg-gray-700 transition-colors duration-200"
                      >
